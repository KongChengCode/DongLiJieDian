	...
	$(function(){
		...
		$("#saveBundActivityBtn").click(function () {
			...
			$.ajax({
				...
				/** 注意这里的数据格式，它不是json类型的这个格式，它是由字符串拼接而成的，其效果相当于将这个字符串添加在url地址栏的最后面 */
				data:ids,
				dataType: 'json',
				type:'post',
				success:function (data) {
					if (data.code == "1") {
						...
						$("#ralationedTBody").append(htmlStr);
					} else {
						alert(data.message);
						$("#bundModal").modal("show");
					}
		...
		//给“解除关联”按钮添加单击事件
		$("#ralationedTBody").on('click','a',function () {
			//收集参数
...
<body>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${clue.appellation}</b></div>
