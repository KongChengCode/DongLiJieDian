			...
			$.ajax({
				...
				success:function (data) {
					if (data.code == "1") {
						...
						htmlStr += "				<a class='myHref' name='editA' href='javascript:void(0);' remarkId='"+data.retData.id+"'><span class='glyphicon glyphicon-edit' style='font-size: 20px; color: #E6E6E6;'></span></a>";
						htmlStr += "				&nbsp;&nbsp;&nbsp;&nbsp;";
						htmlStr += "				<a class='myHref' name='deleteA' href='javascript:void(0);' remarkId='"+data.retData.id+"'><span class='glyphicon glyphicon-remove' style='font-size: 20px; color: #E6E6E6;'></span></a>";
						htmlStr += "			</div>";
						htmlStr += "		</div>";
						htmlStr += "</div>";

						/**
						 * 手动输出与再次请求数据库向比较而言，手动输出速度更快，效率更高
						 */
			...
			$.ajax({
				...
				success:function (data) {
					if (data.code == "1") {
						...
						/** <small style='color: gray;'> "+data.retData.createTime+" 由${sessionScope.sessionUser.name}创建</small> */
		...
		<c:forEach items="${remarkList}" var="remark">
			<div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					<h5 id="h5_${remark.createBy}">${remark.noteContent}</h5>
